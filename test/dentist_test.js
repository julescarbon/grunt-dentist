...
exports.dentist = {
  ...
  clear_scripts: function(test) {
    ...
    test.equal(actual_html.indexOf("<!-- comment here"), -1, 'should not contain comments.');
    test.notEqual(actual_html.indexOf("<!--[if"), -1, 'should preserve conditional comments.');
    test.notEqual(actual_html.indexOf("multiline"), -1, 'should preserve multiline comments.');
